...
<head>
  ...
  <title>BALOI KESBANGPOL TANA TIDUNG 1.0| Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="app/index3.php"><b>BALOI</b>KTT</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">BALOI KESBANGPOL TANA TIDUNG 1.0</p>

    <form action="app/index3.php" method="post">
